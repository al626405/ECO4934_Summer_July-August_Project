...
CREATE TABLE Train (
    ...
    "when" TEXT,
    who INTEGER,
    current_resolution_DUPLICATE INTEGER,
    current_resolution_FIXED INTEGER,
    current_resolution_INVALID INTEGER,
    current_resolution_NOT_ECLIPSE INTEGER,
    current_resolution_WONTFIX INTEGER,
    current_resolution_WORKSFORME INTEGER,
    current_status_CLOSED INTEGER,
    current_status_RESOLVED INTEGER,
    current_status_VERIFIED INTEGER,
    priority_NONE INTEGER,
    priority_P1 INTEGER,
    priority_P2 INTEGER,
    priority_P3 INTEGER,
    priority_P4 INTEGER,
    ...
    version_1_1 INTEGER,
    version_1_1_0 INTEGER,
    version_1_1_1 INTEGER,
    version_1_2 INTEGER,
    ...
    version_2_3_1 INTEGER,
    version_2_4_0 INTEGER,
    version_2_5_0 INTEGER,
    version_2_6_0 INTEGER,
    version_2_7_0 INTEGER,
    version_2008_Ganym INTEGER,
    version_3_0 INTEGER,
    ...
    version_Europa INTEGER,
    version_dev INTEGER,
    version_unspecifie INTEGER,
